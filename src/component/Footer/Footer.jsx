...
const Footer = () => {
    return (
        <div>
            ...
            <p>React is a JavaScript library for building user interfaces. It was created by Facebook and is widely used in web development. React works by allowing developers to create reusable UI components that can be composed to build complex user interfaces. <br /> React's combination of reusable components, virtual DOM, unidirectional data flow, and JSX make it a powerful tool for building fast and scalable user interfaces.</p>
        </div>
    );
};
